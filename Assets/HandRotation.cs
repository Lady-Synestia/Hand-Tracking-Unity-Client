...
public class HandRotation : MonoBehaviour
{
    ...
    public Transform thumbBase; // Base positions of each finger from OpenCV

    void Update()
    {
        // Step 1: Calculate the direction vector from wrist to the index base
        Vector3 wristToBaseDirection = indexBase.position - wristPosCV.position; // this should do x and y rot
        Vector3 wristToThumbDirection = thumbBase.position - wristPosCV.position; // this should do z rotation
